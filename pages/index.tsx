...
function Hero_Section() {
  return (
    <>
      <div className="max-w-2xl p-4 py-40 mx-auto">
        ...
        <div className="my-4 space-y-4 text-start md:text-center">
          ...
          <div className="flex items-start justify-start mt-10 md:items-center md:justify-center gap-x-6">
            <Link
              href="/projects"
            ...
            <Link href="/about" className="inline-flex items-center gap-2 text-base font-semibold leading-6 text-gray-900 dark:text-primary-100">
              Get To Know Me
            </Link>
          </div>
        </div>
