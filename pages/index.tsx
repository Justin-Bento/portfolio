    ...
    <>
      ...
      <main className="p-4 my-12 md:my-24">
        <section className="grid items-center grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="">
            <p className="max-w-xl text-lg lg:text-xl leading-10 tracking-wide text-[#443733]">
            ...
            <div className="flex items-center gap-8 mt-8">
              <Link href="https://github.com/Justin-Bento" target="_blank">
              ...
              <Link href="https://www.linkedin.com/in/justin--bento/" target="_blank">
