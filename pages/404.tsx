  ...
  return (
    <div className="grid h-screen px-6 py-24 place-items-center sm:py-32 lg:px-8 [min-height:100dvh]">
      <div className="">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight capitalize text-slate-900 dark:text-slate-200 sm:text-5xl">
          Oops! we couldn&#39;t find you&#39;re page.
        </h1>
        <p className="mt-6 text-base lg:text-xl lg:max-w-[64ch] lg:mx-auto tracking-wide leading-7 dark:text-primary-40 text-slate-600">
