      ...
      <main className="p-4 lg:gap-6 lg:p-8 3xl:container 3xl:mx-auto">
        <section className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <Card className="col-span-12 bg-secondary/10 border-transparent">
            <div className="min-h-[65svh] xl:min-h-[36rem] flex items-center w-11/12 mx-auto ">
              <div className="space-y-3">
                ...
                <p className="text-balance text-black opacity-70 line-clamp-2">
                  ...
                  arranged in a clean, organized, and visually pleasing way. Each section in this grid is like a
                  carefully placed item within a bento box, designed to create harmony and balance.
                </p>
              </div>
            </div>
          </Card>
