...
export default function Home() {
  return (
    <>
      <Navigation />
      <main className="lg:p-8 min-h-dvh 3xl:container 3xl:mx-auto">
        <section className="grid grid-cols-1 md:grid-cols-12 p-4 gap-6">
          {/* Main Hero Section */}
          <Card className="col-span-12 min-h-[65svh] lg:min-h-[50rem] flex items-center justify-center">
          ...
          {/* About Me Card */}
          <Link href="/about" className="col-span-12 lg:col-span-4 flex flex-col items-start justify-center">
            <Card className="px-4 py-5 sm:p-6 space-y-3 h-[25vh] xl:h-64">
          ...
          {/* Projects Card */}
          <Link href="/projects" className="col-span-12 lg:col-span-4 flex flex-col items-start justify-center">
            <Card className="px-4 py-5 sm:p-6 space-y-3 h-[25vh] xl:h-64">
              <h2 className="text-md/7 font-semibold text-zinc-950 dark:text-white">Some Things I&#39;ve Built</h2>
              <p className="text-base/6 text-gray-700 sm:text-sm/6 dark:text-gray-400 line-clamp-4">
                I love building interactive projects for the web because it allows me to bring ideas to life in ways
                that are both functional and engaging. Over the years, I&#39;ve had the opportunity to work on a wide
                range of projects, from personal blogs to complex web applications and even simple games. Each project,
                no matter how small or large, has been a chance to learn something new, refine my skills, and deepen my
                understanding of core principles. I believe that the fundamentals are the foundation of great
                development, so I regularly revisit the basics to sharpen my skills and ensure my code is both clean and
                efficient.
              </p>
          ...
          <Link href="/experience" className="col-span-12 lg:col-span-4 flex flex-col items-start justify-center">
            <Card className="px-4 py-5 sm:p-6 space-y-3 h-[25vh] xl:h-64">
              ...
              <p className="text-base/6 text-gray-700 sm:text-sm/6 dark:text-gray-400 line-clamp-4">
                ...
                world of web development. I quickly realized that it was something I genuinely enjoyed and felt driven
                to pursue.
              </p>
