...
export default function Project_Card(props: Project_Card_Props) {
  return (
    <>
      <Link href={props.Link} className={style.project_card}>
        <article className={style.project_card_surface}>
          <div className={style.project_card_icon}>
            <div className={style.project_card_icon_box}>
          ...
          <div className="">
            ...
            <button type="button" className={style.project_card_footer}>
